...
※ 인터페이스 멤버 변수인 테이터는
	...
	★기본상수 (primitive constant)인static final의 변경자로 설정된다.
...
//				↓
//두 인터페이스를 상속 받은 인터페이스 (CDemo)를 구현한후
//모든 메소드를 재 정의 한 클래스
